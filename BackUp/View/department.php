...
$sql = "SELECT id,name FROM department where userid=$userid and companyid=$companyid";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    $name=$row["name"];
     ...
     echo "<td class='departmentname'>".$name."</td>"; 
     ...
     echo "<td class='text-center py-0 align-middle' style='text-align:center;'>
                      <div class='btn-group btn-group-sm'>
                        ...
                        <a onclick=deletedata($id,this,'department') class='btn btn-danger'><i class='fas fa-trash'></i></a>
                      </div>
                    </td>";
     echo "</tr>";
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" id="department" style="width:25%" class="form-control" placeholder="Department Name">
              </div>
