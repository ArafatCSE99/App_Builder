...
if($up_name!="" && $dis_name!="")
{
  ...
  <div class="row">
    ...
    <div class="col-sm-9" style="padding-left:20px;">
       ...
       <h5 style="margin-top:5px; margin-bottom:10px;"><b><?php echo "Sales Report" ?></b><h5></span>
       <?php 
         if($s_dtfrom!="")
         {
...
$sql = "SELECT * FROM sales_master where userid=$userid and companyid=$companyid and branchid=$branchid and (employeeid=$s_ctg or $s_ctg=0)";
//echo $sql;
$result = $conn->query($sql);
if ($result->num_rows > 0) {
  // output data of each row
