...
<div class="content-wrapper">
    ...
    <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title" >List of Purchase Cost</h3>
...
$sql = "SELECT * FROM purchase_cost where userid=$userid";
...
if ($resultc->num_rows > 0) {
  ...
  while($rowc = $resultc->fetch_assoc()) {
    $categoryname=$rowc["name"];
     ...
     echo "<td class='expense_date'>".$row["cost_date"]."</td>"; 
     ...
     echo "<td class='text-center py-0 align-middle' style='text-align:center;'>
                      <div class='btn-group btn-group-sm'>
                        ...
                        <a onclick=deletedata($id,this,'purchase_cost') class='btn btn-danger'><i class='fas fa-trash'></i></a>
                      </div>
                    </td>";
     echo "</tr>";
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Add Purchase Cost</h3>
