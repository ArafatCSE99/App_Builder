...
<div class="content-wrapper">
    ...
    <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title" >List of Cash Transaction</h3>
...
$sql = "SELECT * FROM cash_transaction  where (userid=0 or userid=$userid) and companyid=$companyid";
    ...
    $user=$row["userid"];
     ...
     if($user!=0){
                    echo "<div class='btn-group btn-group-sm'>
                        ...
                        <a onclick=deletedata($id,this,'cash_transaction') class='btn btn-danger' style='color:white;'><i class='fa fa-trash'></i></a>
                      </div>";
     }
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Add Cash Transaction</h3>
