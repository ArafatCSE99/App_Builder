...
<td style='text-align:center; float:left;'colspan='4'><b><span style='font-size:24px;  font-family: Lucida Console, Courier, monospace;'>".$companyname."</b></span><br>Branch Manager : ".$branch_Manager."<br>".$branch_Address."<br>Contact : ".$branch_Phone."</td>";
...
?>
                  ...
                  <div id="footer"><table  class="table" style="width:100%; font-size:18px;"><tr style='border-top:none;'><td style='text-align:center;'>Received By</td> <td style='text-align:center;'>Prepared By<br><?php echo $sales_by." <br>".$sales_date ?></td> <td style='text-align:center;'>Checked By<br><?php echo $user_name." <br>".$sales_date ?></td> <td style='text-align:center;'>Authorized By</td> </tr>
</table></div>
