...
{ 
       ...
       if(id==0){
        var sql="INSERT INTO `basic_info`( `userid`, `shop_name`, `shop_categoryid`, `mobileno`, `facebook`, `division_id`, `district_id`, `upazila_id`, `union_id`,address, `logo`) VALUES ("+userid+",'"+name+"','"+shopcategory+"','"+mobileno+"','"+facebook+"','"+division+"','"+district+"','"+upazila+"','0','"+caddress+"','"+imag_name+"')";
       }
       else{
