...
today=dates;
       ...
       if(id==0){
        var sql="INSERT INTO cash_transaction (`userid`,companyid, `date`, `bank_accountid`, `previous_balance`, `amount`, `current_balance`,transaction_type) VALUES ('"+userid+"','"+companyid+"','"+today+"','"+bank_accountid+"','"+previous_balance+"','"+amount+"','"+current_balance+"','"+transaction_type+"')";
        //alert(sql);
       }
       else{
        var sql = "UPDATE cash_transaction SET bank_accountid='"+bank_accountid+"', previous_balance='"+previous_balance+"',amount='"+amount+"',current_balance='"+current_balance+"',transaction_type='"+transaction_type+"' WHERE id="+id;
       }
