...
$sql = "SELECT * FROM subuser where userid=$userid";
...
$sqlc = "SELECT * FROM roles where id=$roleid";
...
if ($resultc->num_rows > 0) {
  ...
  while($rowc = $resultc->fetch_assoc()) {
    $rolename=$rowc["name"];
     ...
     echo "<td class='role'>".$rolename."</td>"; 
     echo "<td class='user_name'>".$user_name."</td>"; 
     ...
     echo "<td class='text-center py-0 align-middle' style='text-align:center;'>
                      <div class='btn-group btn-group-sm'>
                        ...
                        <a onclick=delete_masterdata($id,this,'subuser') class='btn btn-danger'><i class='fas fa-trash'></i></a>
                      </div>
                    </td>";
     echo "</tr>";
...
<section class="content" id="add">
  ...
  <input type="hidden" name="subuserid" id="subuserid"  value="0">   
...
echo "<select style='width:80%' class='form-control' id='role' name='role' required>";
echo "<option hidden='' value=''>--Select user role--</option>";
...
<div class="form-group">
  ...
  <input type="text" id="user_name" name="user_name" style="width:80%" class="form-control" placeholder="user name">
</div>

<div class="form-group">
                <label for="">Password</label>
                <input type="text" id="password" name="password" style="width:80%" class="form-control" placeholder="password">
              </div>
