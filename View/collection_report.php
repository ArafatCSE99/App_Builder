...
$sql = "SELECT a.*,b.*,a.discount as pay_discount FROM sales_payment a,sales_master b where a.salesid=b.id and b.userid=$userid and b.companyid=$companyid and b.branchid=$branchid order by b.customerid,a.payment_date";
//echo $sql;
$result = $conn->query($sql);
if ($result->num_rows > 0) {
  // output data of each row
