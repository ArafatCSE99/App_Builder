...
echo $dynamicComponent->createComponent('Department ', '0', 'dropdown', 'form-group', 'department_id', '', 'department', 'name', 'name', '', '', '');
 ?> &nbsp;&nbsp; <button type="button" onclick="ReportRefresh()"
...
$columns = [
    ...
    'total_hours_done' => 'Total Hours',
    'department_id' => 'Department Name',
];

echo $tableComponent->GetTable($master_conn, 'employee_report_vw', $columns, $page, $limit, $search);
