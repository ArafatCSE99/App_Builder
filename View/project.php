...
echo $tableComponent->GetTable($master_conn, 'project', $columns, $page, $limit, $search);
...
<section class="content" id="add">
 ...
 ?> <input type="button"  onclick="saveData('project')"  value="Save" class="btn btn-success float-left saveButton">
