...
if($up_name!="" && $dis_name!="")
{
  ...
  <div class="row">
    ...
    <div class="col-sm-8" >
       ...
       <center><h5 style="margin-top:5px; margin-bottom:10px;"><b><?php echo "Stock Report (Category Wise)" ?></b><h5></span></center>
...
// Get purchase .......
$sqlc = "SELECT * FROM purchase_detail where productid in (select id from product where categoryid=$id)";
$resultc = $conn->query($sqlc);
