...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Over Due Report</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Over Due Report</li>
            </ol>
          </div>
        </div>
...
if($up_name!="" && $dis_name!="")
{
  ...
  <div class="row">
    ...
    <div class="col-sm-9" style="padding-left:20px;">
       ...
       <h5 style="margin-top:5px; margin-bottom:10px;"><b><?php echo "Over Due Report" ?></b><h5></span>
       <?php 
         if($s_dtfrom!="")
         {
...
if( (($dt>=$s_dtfrom && $dt<=$s_dtto) or $s_dtfrom=="") && $bgcolor=="green" ){
