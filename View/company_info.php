...
echo $tableComponent->GetTable($master_conn, 'company_info', $columns, $page, $limit, $search);
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body"> <?php echo $dynamicComponent->createComponent('Company Name', '', 'textbox', 'form-group', 'name', 'required');
echo $dynamicComponent->createComponent('email', '', 'textbox', 'form-group', 'email', 'required');
echo $dynamicComponent->createComponent('Image', '', 'image', 'form-group', 'img', '');
 ?> <input type="button" onclick="saveData('company_info')" value="Save"
